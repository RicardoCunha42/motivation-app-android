package com.milliways.motivation.data
...
class Mock {
    ...
    fun getPhrase(id: Int, language: String): String {
        ...
        val filtered = this.listPhrases.filter {
            (it.categoryId == id || id == all) && it.language == langFilter
        }
        ...
        /*when(id) {
            this.all -> {
                ...
                var phrase: Phrase = this.phrases.get(index)
